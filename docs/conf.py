...
# Warn about any unfound references
nitpicky = True
...
#
# html_title = 'Brains Copy Paste v0.2'
...
latex_documents = [
    (master_doc, 'BrainsCopyPaste.tex', 'Brains Copy Paste Documentation',
     'Sébastien Lerique', 'manual'),
]
...
man_pages = [
    (master_doc, 'brainscopypaste', 'Brains Copy Paste Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'BrainsCopyPaste', 'Brains Copy Paste Documentation',
     author, 'BrainsCopyPaste',
     'Toolchain for analysing word substitutions in quotes online.',
     'Research'),
]
