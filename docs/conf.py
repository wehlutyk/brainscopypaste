...
extensions = ['sphinx.ext.autodoc', 'numpydoc', 'sphinx.ext.todo', 'sphinx.ext.coverage', 'sphinx.ext.mathjax', 'sphinx.ext.viewcode']
...
texinfo_documents = [
  ('index', 'WebQuotes', u'Web Quotes Documentation',
   u'Sébastien Lerique & Camille Roth', 'WebQuotes', 'One line description of project.',
   'Miscellaneous'),
]
