...
base_prefix = '{fra}F_{lem}L_{syn}S_{ntb}_{b1}-{b2}_'
N = {0: 'N', 1: ''}
...
pl.plot(degrees_ratio_averages[o_dra] - degrees_ratio_stds[o_dra], 'm-', linewidth=1)
pl.plot(degrees_ratio_averages[o_dra] + degrees_ratio_stds[o_dra], 'm-', linewidth=1)
pl.legend(['averages', 'medians', 'av +/- std'])
pl.title('Degrees ratio (sorted by incresing average)')
...
pl.plot(PRscores_ratio_averages[o_sra] - PRscores_ratio_stds[o_sra], 'm-', linewidth=1)
pl.plot(PRscores_ratio_averages[o_sra] + PRscores_ratio_stds[o_sra], 'm-', linewidth=1)
pl.legend(['averages', 'medians', 'av +/- std'])
pl.title('PRscores ratio (sorted by incresing average)')
...
pl.plot(degrees_diff_averages[o_dda] - degrees_diff_stds[o_dda], 'm-', linewidth=1)
pl.plot(degrees_diff_averages[o_dda] + degrees_diff_stds[o_dda], 'm-', linewidth=1)
pl.legend(['averages', 'medians', 'av +/- std'])
pl.title('Degrees diff (sorted by incresing average)')
...
pl.plot(PRscores_diff_averages[o_sda] - PRscores_diff_stds[o_sda], 'm-', linewidth=1)
pl.plot(PRscores_diff_averages[o_sda] + PRscores_diff_stds[o_sda], 'm-', linewidth=1)
pl.legend(['averages', 'medians', 'av +/- std'])
pl.title('PRscores diff (sorted by incresing average)')
