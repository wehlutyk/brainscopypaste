...
packages, then uses the methods defined in other analysis packages to give an
object-oriented interface to the data. As an example, the visualize package
defines methods to plot data from the MemeTracker dataset, and the Cluster and
Quote object in the memetracker module here define methods that wrap those
